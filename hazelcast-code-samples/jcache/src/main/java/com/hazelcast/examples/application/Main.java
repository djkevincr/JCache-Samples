...
import com.hazelcast.examples.iterator.CacheIteratorUsage;
...
public class Main {
    ...
    private static Cache<Integer, User> configureCache(UserDao userDao) {
        ...
        staticClass.setInctance(userDao);
        Properties properties = new Properties();
        properties.setProperty( HazelcastCachingProvider.HAZELCAST_CONFIG_LOCATION,
                "file:///home/djkevincr/gsoc_2016/hazelcast-code-samples/jcache/src/main/resources/hazelcast.xml" );
